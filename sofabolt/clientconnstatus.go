...
func (cs ClientConnStatus) String() string {
	switch cs {
	case IdleClientConnStatus:
		return "Idle"
	case ConnectingClientConnStatus:
		return "Connecting"
	case ActiveClientConnStatus:
		return "Active"
	case ReadTimeoutClientConnStatus:
		return "ReadTimeout"
	case TransientFailureClientConnStatus:
		return "TransientFailure"
	case ShutdownClientConnStatus:
		return "Shutdown"
	default:
		return "Invalid"
	}
